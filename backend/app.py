...
from app_function_call import initiate_function,input_function_call,forecast_aligner_function_call,model_selector_function_call
...
# print(segmented_df)
output_df = model_selector_function_call(PAST_SALES_DATA_AVAILABLE,PAST_FORECAST_DATA_AVAILABLE,cleaned_future_forecast,cleaned_actual,cleaned_forecast)
# print(output_df)
