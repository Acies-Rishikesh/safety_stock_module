...
#     segmented_df.to_excel("grouped_accuracy_metrics.xlsx", index=False)
#     return segmented_df

# def model_selector_function_call(segmented_df,cleaned_future_forecast,cleaned_actual,cleaned_forecast):
#     # output_df = run_safety_stock_selector(segmented_df,cleaned_future_forecast,)
#     output_df = run_safety_stock_selector(segmented_df,cleaned_future_forecast,cleaned_actual,cleaned_forecast)
#     # print(output_df.head())
#     output_df.to_excel("output_df.xlsx",index=False)
#     return output_df

def model_selector_function_call(PAST_SALES_DATA_AVAILABLE,PAST_FORECAST_DATA_AVAILABLE,cleaned_future_forecast,cleaned_actual,cleaned_forecast):
    # output_df = run_safety_stock_selector(segmented_df,cleaned_future_forecast,)
    run_safety_stock_selector(PAST_SALES_DATA_AVAILABLE,PAST_FORECAST_DATA_AVAILABLE,cleaned_future_forecast,cleaned_actual,cleaned_forecast)
    # print(output_df.head())
    # output_df.to_excel("output_df.xlsx",index=False)
    # return output_df
